...
export const SearchbarTemplate = ({ placeholder }: searchbarProps) => {
  ...
  return (
    <div className="w-full py-2 bg-gray-50 flex items-center px-12 justify-between">
        ...
        <div className="flex text-sm gap-3 items-center">
            <label htmlFor="sort" className="font-semibold text-md text-gray-700">Sort by:</label>
            <select name="sort" className="px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200 ease-in-out">
                <optgroup>
                    <option value="latest" selected className="">Latest</option>
                    <option value="oldest" className="hover:bg-gray-100">Oldest</option>
                    <option value="popularity" className="hover:bg-gray-100">Popularity</option>
                </optgroup>
            </select>
        </div>
